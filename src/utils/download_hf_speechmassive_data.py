...
def download_speech_massive(save_dir, split):
    ...
    # Load the dataset
    dataset = load_dataset("FBK-MT/Speech-MASSIVE", "pt-PT", split=split)
    ...
    if split == "validation":
        split = "dev"
    dataset_name = f"speech_massive_pt-PT_{split}.parquet"
...
if __name__ == "__main__":
    ...
    #split can be 'train', 'train_115', 'validation', 'test'
    split = "train_115"
